...
Route::get('/guru/ajax', 'JadwalController@ajax');

Route::get('/', 'LandingPageController@landing');

Route::get('/verif', 'VerifikasiDaftarController@verif');
...
Route::middleware(['auth'])->group(function () {
  ...
  Route::middleware(['guru'])->group(function () {
    ...
    Route::get('/ulangan/show2/{id}/{mapel_id}', 'UlanganController@show2')->name('ulangan.show2');
    Route::get('/sikap/show2/{id}/{mapel_id}', 'SikapController@show2')->name('sikap.show2');
    ...
    Route::get('/rapot-siswa/cetak_pdf/{id}', 'RapotController@cetak_pdf')->name('rapot-siswa.pdf');
    Route::get('/rapot/show2/{id}/{mapel_id}', 'RapotController@show2')->name('rapot.show2');
  });
  ...
  Route::middleware(['admin'])->group(function () {
    ...
    Route::get('/listsiswapdf/{id}/cetak', 'SiswaController@cetak_pdf')->name('siswa.pdf');
    ...
    Route::get('/verifikasi/{id}', 'VerifikasiController@index')->name('verifikasi.index');
    Route::get('/verifikasi/coba/export_excel', 'VerifikasiController@export_excel')->name('verifikasi.export_excel');
    Route::get('/verifikasi/export_pdf/{id}', 'VerifikasiController@export_pdf')->name('verifikasi.pdf');

    Route::get('/verifikasi/ajaran/index', 'VerifikasiController@ajaran')->name('verifikasi.ajaran.index');
    Route::post('/verifikasi/ajaran', 'VerifikasiController@ajaran_store')->name('verifikasi.ajaran.store');
    Route::get('/verifikasi/ajaran/{id}', 'VerifikasiController@ajaran_edit')->name('verifikasi.ajaran.edit');
    Route::put('/verifikasi/ajaran/{id}', 'VerifikasiController@ajaran_update')->name('verifikasi.ajaran.update');
    Route::delete('/verifikasi/ajaran/{id}', 'VerifikasiController@ajaran_delete')->name('verifikasi.ajaran.delete');
    Route::get('/verifikasi/coba/send_email/{id}', 'VerifikasiController@send_email')->name('verifikasi.send_email');
    Route::get('/verifikasi/coba/send_email_gagal/{id}', 'VerifikasiController@send_email_gagal')->name('verifikasi.send_email_gagal');
    Route::get('/mapel/getMapelJson', 'MapelController@getMapelJson');
    Route::resource('/mapel', 'MapelController');
    Route::get('/jadwal/view/json', 'JadwalController@view');
    Route::get('/jadwalkelaspdf/{id}/cetak', 'JadwalController@cetak_pdf')->name('jadwal.pdf');
    ...
    Route::get('/predikat/detail/{id}', 'NilaiController@detail')->name('predikat.detail');
