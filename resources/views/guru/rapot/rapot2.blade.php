...
@section('heading', 'Masukan Nilai Rapot')
@section('page')
    <li class="breadcrumb-item active">Masukan Nilai Rapot</li>
@endsection
@section('content')
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Masukan Nilai Rapot</h3>
                                    ...
                                    @foreach ($siswa as $data)
                                        ...
                                        <tr>
                                            ...
                                            @if ($data->nilai($data->id))
                                                ...
                                                <td class="ctr">
                                                    <div class="text-center">{{ $data->nilai($data->id)->p_predikat }}
                                                    </div>
                                                </td>
                                                <td class="ctr">
                                                ...
                                                @if ($data->nilai($data->id)->p_nilai && $data->nilai($data->id)->k_nilai)
                                                    <td class="ctr">
                                                        <div class="ka_{{ $data->id }} text-center">
                                                            {{ $data->nilai($data->id)->k_nilai }}</div>
                                                    </td>
                                                    <td class="ctr">
                                                ...
                                                @else
                                                    ...
                                                    <td class="ctr">
                                                        <input type="text" name="predikat"
                                                            class="form-control text-center predikat_{{ $data->id }}"
                                                            disabled>
                                                        <div class="kpredikat_{{ $data->id }} text-center"></div>
                                                    </td>
                                                    <td class="ctr">
                                                        <textarea class="form-control swal2-textarea textarea-rapot deskripsi_{{ $data->id }}" cols="50"
