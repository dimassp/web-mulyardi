    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Masukan Nilai Ulangan</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="row">
                                            ...
                                            <td class="ctr">
                                                @if ($data->ulangan($data->id) && $data->ulangan($data->id)['ulha_2'])
                                                    <!-- <div class="text-center">
                                                        {{ $data->ulangan($data->id)['ulha_2'] }}
                                                    </div> -->
                                                    <input name="ulha_2" maxlength="2"
                                                        onkeypress="return inputAngka(event)" style="margin: auto;"
