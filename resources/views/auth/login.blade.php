...
<div class="card-body login-card-body">
  ...
  <form action="{{ route('login') }}" method="post">
    ...
    <div class="input-group mb-3">
      <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="{{ __('Masukan email') }}" name="email" value="{{ old('email') }}" autocomplete="off" autofocus>
  ...
  <p class="mb-0">
    <a class="text-center" href="{{ route('pendaftaran.index') }}">Daftar PPDB</a>
  </p>
</div>
@endsection
@section('script')
