            ...
            <div class="card-header">
                <h3 class="card-title">
                    <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target=".tambah-jadwal">
                        <i class="nav-icon fas fa-folder-plus"></i> &nbsp; Tambih Data Jadwal
                    </button>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if (Auth()->user()->role == 'Admin')
                                        <a href="{{ route('jadwal.pdf', Crypt::encrypt($data->id)) }}"
                                            class="btn btn-danger btn-sm my-3" target="_blank"><i
                                                class="nav-icon fas fa-file-export"></i> &nbsp; Cetak</a>
                                    @endif
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#kelas_id').change(function(e) {
                e.preventDefault();
                idKelas = $('#kelas_id').val();
                console.log(idKelas)
                if (idKelas == '') {
                    $('#mapel_id').attr('disabled', 'disabled');
                } else {
                    $('#mapel_id').removeAttr('disabled');
                }
            });

            $('#mapel_id').change(function(e) {
                e.preventDefault();
                idMapel = $('#mapel_id').val();
                console.log(idMapel)
                console.log(idKelas)
